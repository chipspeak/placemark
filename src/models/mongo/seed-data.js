export const seedData = {
  ...
  placemarks: {
    ...
    river: {
      ...
      "category": "River",
      "userId": "->users.homer",
      "img": ["/images/river.jpg", "/images/glendalough.jpg"]
    ...
    maynoothPark: {
      ...
      "category" : "Park",
      "userId": "->users.homer",
      "img" : ["/images/maynooth-playground.jpg", "/images/glendalough.jpg"]
    ...
    woodstownBeach: {
      ...
      "category" : "Beach",
      "userId": "->users.homer",
      "img" : ["/images/place-woodstown-beach.jpg", "/images/glendalough.jpg"]
